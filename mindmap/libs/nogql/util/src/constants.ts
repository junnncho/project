...
export const userRoles = ["root", "admin", "user", "verifiedUser", "premium", "guest"] as const;
...
export const videoStatuses = ["active", "restricted", "inactive"] as const;
...
export const depositStatuses = ["deposit", "withdraw", "exchange", "root-withdraw", "root-deposit"] as const;
...
export const specials = ["highProfit", "zeroWithdrawFee", "Referral0.8%", "Referral1.2%"] as const;
...
export const flowStatuses = ["node", "root", "content"] as const;
...
export const edgeStatuses = ["active", "inactive"] as const;
export type EdgeStatus = (typeof edgeStatuses)[number];

export const textStatuses = ["public", "private", "inactive"] as const;
