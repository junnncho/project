...
Your referral code is a URL of the form "https://t.me/${env.dashboard}?start=(Personal Referral Code of User)" that is listed on the dashboard. You can also go to "https://t.me/${env.dashboard}" and enter the (유저의 개인 레퍼럴 코드) code to register.
